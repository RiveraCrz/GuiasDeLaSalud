    ...
    <body>
      <section>
        ...
        <div class="modal-body bg-success">
          ...
          <h5 class="modal-title" id="exampleModalLongTitle">Validación Segundo Paso</h5>
                <form action="codeval.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="emailInputId">Ingresa el código enviado a tu correo.</label>
                      <?php if (isset($_GET['emailOrUname'])){ ?>
                      <input type="text" class="form-control mb-3" id="emailOrUser" name="emailOrUname" value="<?php echo $_GET['emailOrUname']; ?>">
                      <?php } ?>
                      <input type="text" class="form-control" id="codigoId" name="codigo" placeholder="Código">
                    </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-light" data-toggle="modal" data-target="#RecuperarPass" onclick="ValidateInputsEmails();">¿No te llegó el código?</button>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="get-pass.php" method="post">
                    <div class="form-group">
                    <p>Si tu correo fue registrado se enviará un correo con el código</p>
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary" id="button-send">Obtener Código</button>
                    </div>
                  </form>
                </div>
                <div class="modal-footer">
