        ...
        <div class="modal-body">
          ...
          <form action="insert-user.php" method="post">
                ...
                <div class="form-row">
                    ...
                    <input type="email" class="form-control" id="inputEmailNew" name="email" placeholder="Email">
                    </div>
                    <div class="form-group col-md-6">
                    <label for="inputUserName">Nombre de Usuario</label>
                    <input type="text" class="form-control" id="inputUserNameNew" name="uname" placeholder="Tu usuario">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword">Contraseña</label>
                    <input type="password" class="form-control" id="inputPasswordNew" name="password" placeholder="Contraseña">
                </div>
                <button type="submit" class="btn btn-primary" data-dismiss="modal">Guardar</button>
                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#CancelRegister">Cancelar</button>
            </form>
